...
$nomeProd=$_GET["produto"];
$produtos .="WHERE nomeproduto LIKE '%$nomeProd%'";
...
<body>
    ...
    <div id="janela_pesquisa">
        <form action="inicial.php" method="GET">
         <input type="search" name="produto" id="produto" placeholder="Pesquisa produto">
       
         <input type="image" name="pesquisa" id="pesquisa" src="assets/botao_search.png">
